      ...
      <div className="p-4">
          ...
          <div className="row align-items-center">
            <div className="col-md-8">
              ...
              <p className="mb-4 opacity-90">
                Access technical documentation, user guides, manuals, and reference materials.
              </p>
            </div>
            <div className="col-md-4 text-end">
              <FileText size={120} className="opacity-25" />
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-bottom">
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <h5 className="mb-1">Documentation Library</h5>
                    ...
                    <div className="card-body">
                      ...
                      <div className="mb-3">
                        <div className="mb-2">
                          ...
                          <span className="badge bg-secondary ms-2">Documentation</span>
                        </div>
